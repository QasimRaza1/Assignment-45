...
let names = ["Qasim", "Raza", "Aishhh", "Ashu"];
...
// Question 12
// Store the names of friends in an array
let names1 = ["Qasim", "Raza", "Aishhh", "Ashu"];
...
let languages = ['English', 'Japanese', 'Spanish'];
let population = 125584838;
// Test 1: True
...
let age2 = 25;
let isStudent2 = true;
let isStudent3 = false;
let languages2 = ['English', 'Japanese', 'Spanish'];
let population2 = 125584838;
// Initial Tests
// Test 1: True
console.log("Is car == 'subaru'? I predict True.");
...
// Question 38
function describe_city(city3, country3 = 'Unknown') {
...
// Question 39
function city_country(city4, country4) {
...
const magicians = ["Qasim", "Raza", "Ayesha", "Aishh", "Shudain"];
...
// Question 42
// Step 1: Create an array of magician's names
const magicians1 = ["Qasim", "Raza", "Ayesha", "Aishh", "Shudain"];
// Step 2: Define the show_magicians() function
function show_magicians1(magiciansArray) {
    magiciansArray.forEach(magician => {
        console.log(magician);
    });
}
...
// Question 43
// Step 1: Create an array of magician's names
const magicians2 = ["Qasim", "Raza", "Ayesha", "Aishh", "Shudain"];
// Step 2: Define the show_magicians() function
function show_magicians2(magiciansArray1) {
    magiciansArray1.forEach(magician1 => {
        console.log(magician1);
    });
}
// Step 3: Define the make_great() function
function make_great1(magiciansArray1) {
